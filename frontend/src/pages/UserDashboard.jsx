    ...
    return (
        <div className="min-h-screen bg-[#F4F7FB]">
            ...
            <nav className="bg-white shadow-md px-10 py-4 flex items-center justify-between">
                ...
                {/* Right */}
                <button className="bg-[#FF6F00] text-white px-6 py-2 rounded-lg hover:bg-orange-600 transition">
                    Logout
                </button>
            ...
            <div className="px-10 py-12">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
                    ...
                    <div className="bg-white rounded-3xl shadow-lg p-8 hover:shadow-2xl transition">
                        ...
                        <button className="mt-6 bg-[#0D47A1] text-white px-5 py-3 rounded-xl hover:bg-blue-800 transition">
                            Open
                        </button>
                    ...
                    <div className="bg-white rounded-3xl shadow-lg p-8 hover:shadow-2xl transition">
                        ...
                        <button className="mt-6 bg-[#FF6F00] text-white px-5 py-3 rounded-xl hover:bg-orange-600 transition">
                            Open
                        </button>
